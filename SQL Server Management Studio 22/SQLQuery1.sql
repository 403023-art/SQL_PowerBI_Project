...
VALUES 
('C006', 'Neha Singh', 'neha@gmail.com', '9801112233', 26, 'Female'),
('C007', 'Vikram Patel', 'vikram@gmail.com', '9112233445', 32, 'Male');

INSERT INTO items (id, item, calories, fat, fiber, protein, type, carbs)
VALUES 
(6, 'Caramel Macchiato', 250, 10.0, 1, 8, 'Beverage', 35),
(7, 'Paneer Sandwich', 400, 15.0, 3, 12, 'Food', 45);
...
INSERT INTO items (id, item, calories, fat, fiber, protein, type, carbs)
VALUES
(1, 'Caffe Latte', 190, 7.0, 0, 12, 'Beverage', 19),
(2, 'Cappuccino', 120, 4.5, 0, 8, 'Beverage', 12),
(3, 'Espresso', 5, 0.2, 0, 1, 'Beverage', 1),
(4, 'Americano', 15, 0.1, 0, 1, 'Beverage', 3),
(5, 'Mocha', 290, 10.0, 1, 9, 'Beverage', 35),
(8, 'Iced Coffee', 120, 3.5, 0, 2, 'Beverage', 20),
(9, 'Cold Brew', 5, 0.1, 0, 1, 'Beverage', 2),
(10, 'Frappuccino', 300, 12.0, 1, 6, 'Beverage', 40),
(11, 'Blueberry Muffin', 320, 14.0, 2, 5, 'Food', 45),
(12, 'Chocolate Croissant', 300, 18.0, 2, 6, 'Food', 30),
(13, 'Veg Sandwich', 350, 12.0, 40, 10, 'Food', 4),
(14, 'Chicken Sandwich', 380, 14.0, 2, 18, 'Food', 35),
(15, 'Paneer Wrap', 400, 15.0, 3, 12, 'Food', 45),
(16, 'Cheese Burger', 450, 20.0, 2, 15, 'Food', 38),
(17, 'Grilled Chicken Wrap', 420, 16.0, 2, 20, 'Food', 30),
(18, 'Veg Puff', 280, 13.0, 2, 6, 'Food', 32),
(19, 'Brownie', 350, 18.0, 2, 5, 'Food', 42),
(20, 'Chocolate Donut', 270, 14.0, 1, 4, 'Food', 33);
INSERT INTO customers (customer_id, customer_name, customer_email, customer_phone, customer_age, customer_gender)
VALUES
...
('T249',101,'2025-04-20 17:30:00','C010',10,1,320,320,'UPI','New');
 INSERT INTO sales (transaction_id, store_id, datetime, customer_id, item_id, quantity, price, total_amount, payment_mode, customer_type)VALUES
